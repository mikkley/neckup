...
final class UpdateChecker: ObservableObject {
    ...
    static let releasePageURL = URL(string: "https://github.com/mikkley/turtleup/releases/latest")!
    static let brewCommand = "brew upgrade --cask turtleup"
    private static let apiURL = URL(string: "https://api.github.com/repos/mikkley/turtleup/releases/latest")!
